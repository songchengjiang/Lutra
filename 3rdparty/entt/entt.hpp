...
public:
    ...
    [[nodiscard]] iterator begin() const ENTT_NOEXCEPT {
        const typename traits_type::difference_type pos = static_cast<const typename traits_type::difference_type>(packed.size());
...
public:
    ...
    [[nodiscard]] iterator begin() ENTT_NOEXCEPT {
        const typename traits_type::difference_type pos = static_cast<const typename traits_type::difference_type>(underlying_type::size());
